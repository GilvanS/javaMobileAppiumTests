package org.br.com.mobile.utils.dataUsers;

import org.apache.poi.ss.usermodel.*;
import org.br.com.mobile.hooks.HooksUsers;
...
public class Users {
    ...
    private static String obterInformacao(String tag, int coluna) {
        ...
        try {
            FileInputStream arquivo = new FileInputStream("src/test/resources/data/MassaDados.xlsx");
