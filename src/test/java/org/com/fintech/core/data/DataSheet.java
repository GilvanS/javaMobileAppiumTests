...
import org.com.fintech.core.support.logger.LogFormatter;
...
public abstract class DataSheet<T> {
	...
	/**
	 *  Define o conjunto de registros (recordset) usando o nome da planilha padrão.
	...
	/**
	 *  Define o conjunto de registros (recordset) a partir de um nome de planilha específico.
	...
	/**
	 *  Define o conjunto de registros (recordset) a partir de uma consulta SQL.
	...
	/**
	 *  Obtém o valor de um campo da linha de registro atual ou da próxima linha, se nenhuma linha tiver sido processada.
	...
	/**
	 *  Atualiza um campo na planilha padrão.
	...
	/**
	 * Atualiza um campo em uma planilha específica.
	 * Constrói e executa uma consulta SQL de atualização no formato:
	...
	/**
	 * Executa uma consulta de atualização ou inserção no arquivo Excel.
