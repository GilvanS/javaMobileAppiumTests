...
public class LoginSteps {
    ...
    @And("clico no botão {string} na {string}")
    ...
    @When("valido a exibicao da mensagem {string} na {string}")
    public void validoAExibicaoDaMensagemOláNaTelaDashboard(String nomeBotao, String tela) {
        LoginActions.validarMesagemPorChave(nomeBotao);
    }

    @And("valido a exibicao da mensagem {string} {string}")
    public void validoAExibicaoDaMensagemNãoÉClienteAbraUmaContaNaTelaLogin(String nomeBotao, String tela) {
        LoginActions.validarMesagemPorChave(nomeBotao);
    }
}