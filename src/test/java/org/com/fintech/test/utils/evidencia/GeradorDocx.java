package org.com.fintech.test.utils.evidencia;
...
import org.com.fintech.test.utils.HooksEvidencia;
...
public class GeradorDocx {
    ...
    public static void EvidenciasDocx(String scenarioName) {
        String dirImagens = "target/evidencias/" + org.com.fintech.test.utils.HooksDados.getDeviceName() + "/" + HooksEvidencia.getNomeDaFeature() + "/" + HooksEvidencia.getIdExecucao() + "/" + HooksEvidencia.getNomeCenario() +"/" + "screenshot";
        String dirDocx = "target/evidencias/" + org.com.fintech.test.utils.HooksDados.getDeviceName() + "/" + HooksEvidencia.getNomeDaFeature() + "/" + HooksEvidencia.getIdExecucao() + "/" + HooksEvidencia.getNomeCenario() + "/"+ HooksEvidencia.getNomeCenario() + ".docx";
                    ...
                    for (XWPFTableCell cell : row.getTableCells()) {
                        for (XWPFParagraph paragraph : cell.getParagraphs()) {
                            ...
                            if (cellText.contains(placeholder)) {
                                ...
                                XWPFRun run = paragraph.createRun();
                                run.setFontFamily("Arial");
                                Object valor = org.com.fintech.test.utils.Hooks.getDriver().getCapabilities().getCapability(placeholder);
