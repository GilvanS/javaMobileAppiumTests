...
public class PassagensActions {
	...
	public static void clicarBtnContinuarSemUpgrade() {
		log.info("clico no botão Continuar sem upgrade na tela 'Passagens'");
		acoes().click(passagensPage().getBtnContinuarSemUpgrade());
	}

	public static void clicarBtnConfirmar() {
		log.info("clico no botão Confirmar na tela 'Passagens'");
		acoes().click(passagensPage().getBtnConfirmar());
	}
